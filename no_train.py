...
from models.no_NIG import NormalInverseGammaNetwork
from no_loss import EvidentialRegressionLoss
...
def main():
    ...
    train_data_loader = torch.utils.data.dataloader.DataLoader(train_dataset, batch_size=100, shuffle=True, num_workers=0)

    optimizer = torch.optim.Adam(model.parameters(), lr=int(5e-4))
    max_epoch = 500
